...
export class ProfileService {
  ...
  projects:any = [
    ...
    },
    {
      ...
      imgUrl: 'assets/images/spongo.jpeg',
      tech: 'Angular 16, Bootstrap, JAVA'
    },
    {
      id: 4,
      title: 'Healthocloud Dialysis',
      desc: '',
      ...
      imgUrl: 'assets/images/dialysis.jpeg',
      tech: 'Angular 16, Bootstrap, JAVA, MySQL'
    },
    {
      id: 2,
      title: 'Beauty Bunch Mobile App',
      desc: '',
      ...
      imgUrl: 'assets/images/bbunch.jpeg',
      tech: 'Angular 16, Bootstrap, JAVA, MySQL'
    },
...

    {
      ...
      imgUrl: 'assets/images/redapp.jpeg',
      tech: 'Angular 16, Bootstrap, JAVA, MySQL'
    },
    {
      id: 6,
      title: 'Spring Boot + Angular 16 CRUD Example',
      desc: '',
  ...
  {
      id: 5,
      title: 'CRUD operation using Java Rest API',
      desc: '',
      // livedemo: 'https://mehulk05.github.io/Blog-using-mean/#/',
      // githurl: 'https://github.com/mehulk05/Blog-using-mean',
      // mediumlink: 'https://itnext.io/crud-operation-using-mean-stack-7dfa2f51ec8c',
  ...
  about2 = `Software Tester with 2 years of experience .
  Worked with Software Testing Life Cycle(STLC) and  agile methodologies .
  Expertise in Angular, Java, Java Rest API's, HTML/CSS and UI with Responsive Designs .
  Have good understanding of Bootstrap, MongoDB, and MYSQL`

  about = "Lover of innovation and everything related to generate new knowledge.Face problems with a smile and solve them as soon as possible. Very calculated about the time I spend and work I do."
  resumeurl = "https://docs.google.com/document/d/1WvgbfFc4LwVlo6EfjM00C7WwJC48bSz6/edit?usp=sharing"
  ...
  skillsData: any = [
    ...
    {
      'id': '3',
      'skill': 'HTML, CSS, Angular, Bootstrap',
      'progress': '80%'
    },
    {
      'id': '4',
    ...
    {
      'id': '5',
      'skill': 'Postman API, JIRA Software',
      'progress': '90%'
    },
    {
      'id': '6',
      'skill': 'JAVA Rest APIs',
      'progress': '80%'
    },
    {
      'id': '7',
      'skill': 'Manual Testing, Automation Testing',
      'progress': '80%'
    },
    {
      'id': '8',
  ...
  educationData: any = [
    {
      'id': '1',
      'from_to_year': '2019 - 2012',
      'education': 'Bachelor\'s Degree',
      'stream': 'Bachelor of Engineering',
      'info': `SMT. KAshibai Navale College of Engineering, Pune Institute is NAAC Accredited with Grade- “A” in Pune
Completed B.E in Computer Engineering with 9.54 CGPA.

Maintained above 8 spi in every semester of college academic .`,
...
Completed my Secondary school with 84%.`
  ...
  exprienceData: any = [
    ...
    },
    {
      ...
      Also works on the basics crud operation using Java Rest API`
    },
  //   {
  //     id: 2,
  //     company: 'Growth99',
  ...
  extraCircularInfo: any = [
    ...
    },
    {
      ...
      title: 'Github',
      description: '',
      img: 'assets/images/manishagithub.PNG',
      url: 'https://github.com/ManshaGore'
    },
    {
      id:1,
